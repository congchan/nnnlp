...
def get_args_parser():
    ...
    group1.add_argument('-model_dir', type=str, default='chinese_L-12_H-768_A-12',
                        help='directory of a pretrained BERT model')
    group1.add_argument('-checkpoint', type=str,
                        help='checkpoint of a fine-tuned BERT model')
    group1.add_argument('-output_graph_dir', type=str, default=None,
                        help='directory for the optimized graph')
